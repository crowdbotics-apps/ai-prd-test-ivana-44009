"""
Django settings for ai_prd_test_ivana_44009 project.
...
ROOT_URLCONF = 'ai_prd_test_ivana_44009.urls'
...
WSGI_APPLICATION = 'ai_prd_test_ivana_44009.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_prd_test_ivana_44009 API",
    "DESCRIPTION": "API documentation for ai_prd_test_ivana_44009 App",
    "VERSION": "v1",
}
